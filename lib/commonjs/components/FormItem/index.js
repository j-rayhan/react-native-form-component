...
const FormItem = /*#__PURE__*/React.forwardRef((_ref, ref) => {
  let {
    children,
    ...props
  } = _ref;
  ...
  const [animatedBottom] = React.useState(new _reactNative.Animated.Value(0));
  ...
  if (props.floatingLabel) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(_reactNative.View, {
    ...
    }, props.label && /*#__PURE__*/React.createElement(_Label.default, {
      text: props.label,
      textStyle: [!props.asterik ? {
        ...
        color: animatedBottom.interpolate({
          inputRange: [0, 1],
          outputRange: [_colors.colors.blue, _colors.colors.black]
        })
      }],
    ...
    }, children, /*#__PURE__*/React.createElement(_reactNative.TextInput, _extends({}, props, {
    ...
    })), hasError.status && props.showErrorIcon && /*#__PURE__*/React.createElement(_reactNative.View, {
      style: styles.errorWrapper,
      testID: "error icon wrapper"
    }, /*#__PURE__*/React.createElement(_reactNative.Text, {
      style: styles.exclamation
    }, '\u0021')), props.secureTextEntry && /*#__PURE__*/React.createElement(_reactNative.Pressable, {
      onPress: () => setHideText(!hideText)
    }, /*#__PURE__*/React.createElement(_ShowTextIcon.default, {
      hide: hideText,
      showIcon: props.showIcon,
      hideIcon: props.hideIcon
    })))), hasError.status && /*#__PURE__*/React.createElement(_reactNative.Text, {
      style: [styles.underneathText, props.underneathTextStyle]
    }, props.underneathText || hasError.message));
  }
  return /*#__PURE__*/React.createElement(React.Fragment, null, props.label && /*#__PURE__*/React.createElement(_Label.default, {
    text: props.label,
