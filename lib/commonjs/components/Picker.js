...
function Picker(props) {
  ...
  const [animatedBottom, setAnimatedBottom] = React.useState(new _reactNative.Animated.Value(0));
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, props.label && !props.floatingLabel && /*#__PURE__*/React.createElement(_Label.default, {
    text: props.label,
  ...
  }, props.floatingLabel && props.label && /*#__PURE__*/React.createElement(_Label.default, {
    text: props.label,
    textStyle: props.labelStyle,
    style: [props.labelWrapperStyle, {
      position: 'absolute',
    ...
    numberOfLines: 1
  }, ((_props$items$filter$ = props.items.filter(item => item.value === props.selectedValue)[0]) === null || _props$items$filter$ === void 0 ? void 0 : _props$items$filter$.label) || props.placeholder || '--Pick a value--'), /*#__PURE__*/React.createElement(_reactNative.View, {
    style: [styles.childIconWrapper, props.iconWrapperStyle]
  }, props.pickerIcon || /*#__PURE__*/React.createElement(_reactNative.View, {
  ...
  }), props.type === 'dropdown' ? /*#__PURE__*/React.createElement(_reactNative.ScrollView, {
  ...
  }, props.items.map(item => /*#__PURE__*/React.createElement(_reactNative.Pressable, {
    key: item.value,
  ...
  }, item.label)))) : /*#__PURE__*/React.createElement(_reactNative.View, {
    style: {
      justifyContent: 'flex-end',
      maxHeight: '50%'
    }
  ...
  }, props.label)), /*#__PURE__*/React.createElement(_reactNative.ScrollView, null, props.items.map(item => /*#__PURE__*/React.createElement(_reactNative.Pressable, {
    key: item.value,
